...
#########################################################################################
        ...
        self.gate_conv = nn.Conv1d(out_channels, out_channels, kernel_size=3, padding=1)
...
#########################################################################################
        ...
        gate = self.gate_sigmoid(self.gate_conv(intra_rnn.view(B*S, N, K)))
        intra_rnn = intra_rnn * gate.view(B, S, K, N).permute(0, 3, 2, 1).contiguous()
#########################################################################################
